...
data class ExtendedColors(
    ...
    val ribbonMoon: Color,
    val ribbonStars: Color,
...
val LocalExtendedColors = staticCompositionLocalOf {
    ExtendedColors(
        ...
        ribbonMoon = Color(0xFFF2EEDC),
        ribbonStars = Color(0xFFE6EDF7),
...
fun BlipbirdTheme(
    ...
    val extended = when {
        ...
        spec.accent is Accent.Cockpit -> ExtendedColors(
            ...
            ribbonMoon = Color(0xFFCFE8D8),
            ribbonStars = Color(0xFF9BC7AB),
...
private fun highContrastExtended(darkTheme: Boolean) = ExtendedColors(
    ...
    ribbonMoon = Color.White,
    ribbonStars = Color.White,

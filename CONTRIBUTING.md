...
**Pre-M0.** There is no application code, build system, or CI yet. Contributions
that build out the M0 scaffolding (version catalog, CI, theme engine, parser)
are welcome and should follow the §3 tech stack pins and the §14 M0 exit
criteria.
